 ...
 * @author IsmaelJJL
 */
public class CorreoPeticionNuevaPass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String receptorM = "fipository@gmail.com";/*Correo del usuario que enviara el mensaje con el nuevo codigo*/
        
        String asuntoM = "Solicitud cambio de contraseña"; //Asunto Fijo ya que smp tratara este tema 
        
        String argumentoM = "Solicito mi cambio de contraseña";/*Lo que enviara el admin*/

        // Receptor del mensaje.
        String to = receptorM;

        // Emisor del correo
        String from = request.getParameter("EmailUsu");;
