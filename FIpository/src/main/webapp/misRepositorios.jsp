<%-- 
    Document   : misRepositorios
    Created on : 24 feb. 2024, 16:04:34
    Author     : José Antonio Fajardo Naranjo
    Reconsiderar hacer esta página o basar el diseño en Github y habilitar un filtro
--%>
        ...
        <header>
            ...
            <nav aria-label="breadcrumb" id="breadcrumbs">
                <ol class="breadcrumb p-4">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Mis repositorios</li>
                </ol>
            </nav>
        </header>
        <main>
